...
include("komok-tech:komok-tech-api-dsl-ui")
...
include("komok-tech:komok-tech-logging-api")
include("komok-tech:komok-tech-logging-slf4j")
include("komok-tech:komok-tech-logging-jul")
